...
export const AnimatedThemeToggle = ({ className }: { className?: string }) => {
  ...
  const isDark = mounted ? theme === "dark" : true; // Default to dark as per your app
  ...
  return (
    <Button
      onClick={toggleTheme}
      className={cn("px-2.5 bg-transparent hover:bg-transparent border-none shadow-none", className)}
      variant="outline"
